...
func (b Handler) handleAuthentication(config v52.Config, methods v5.MethodsChunk, client net.Conn) {
...
func (b Handler) handleCommand(config v52.Config, name string, chunk v5.RequestChunk, client net.Conn) {
	var address string
